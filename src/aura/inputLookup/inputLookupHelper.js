...
({
    ...
    */
    createTypeaheadComponent: function(component){
        ...
        console.log('1component.get(v.nameValue)'+component.get('v.nameValue'));
        console.log('1component.get(v.value)'+component.get('v.value'));
        ...
        inputElement.keyup(function(){
            ...
            console.log('2component.get(v.nameValue)'+component.get('v.nameValue'));
        	console.log('2component.get(v.value)'+component.get('v.value'));
        });
        ...
        .bind('typeahead:selected', 
			function(evnt, suggestion){
                ...
                console.log('3component.get(v.nameValue)'+component.get('v.nameValue'));
        		console.log('3component.get(v.value)'+component.get('v.value'));
                
                var locDetEvent = component.getEvent("LocDetailEvt");
                locDetEvent.setParams({"locationName" : suggestion.value });
                locDetEvent.fire();
    ...
    loadValue : function(component, skipTypeaheadLoading){
        ...
        if(!skipTypeaheadLoading) {
                console.log('hiiii');
                this.createTypeaheadComponent(component);
            }
        ...
        action.setCallback(this, function(a) {
            ...
            if(a.error && a.error.length){
                console.log('hi:: '+a.error);
                console.log('Unexpected error: '+a.error[0].message);
                return $A.error('Unexpected error: '+a.error[0].message);
            }
            var result = a.getReturnValue();
            ...
            console.log(':::isLoading:::'+component.get('v.nameValue'));
            if(result){
